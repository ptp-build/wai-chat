export enum ActionCommands {
  ...
  CID_SendMsgRes = 4011,
  CID_SendTextMsgReq = 4012,
  CID_UpdateCmdReq = 4013,
  CID_UpdateCmdRes = 4014,
  CID_UploadMsgReq = 4015,
  CID_UploadMsgRes = 4016,
...
export const ActionCommandsName = {
  ...
  4011: "CID_SendMsgRes",
  4012: "CID_SendTextMsgReq",
  4013: "CID_UpdateCmdReq",
  4014: "CID_UpdateCmdRes",
  4015: "CID_UploadMsgReq",
  4016: "CID_UploadMsgRes",
